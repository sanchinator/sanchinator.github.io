...
The demo used the Spotify API — nothing complex, just enough to show how fast you can wire up something real in .NET. Kevin hit a bug partway through and debugged it live. That was probably the most useful part. It's easy to watch someone who knows what they're doing and assume they just... don't get confused. They do.

The session moved fast. A few things slipped past me and I've flagged them to read up on — the performance improvements mainly, and some of the changes to minimal APIs. If I'm being honest, a reading list is a pretty good outcome for a 45-minute talk.
