...
DeepSeek had been everywhere in the news for a few weeks before this session. I knew already what it was - an open-source AI model from China that somehow matched GPT-4 performance and apparently rattled investors enough to wipe billions off Nvidia's market cap in a single day. That's a headline, not an explanation. Dimitri Casier got into how this is possible.
...
The broader takeaway from the session is that AI in 2025 looks different from what it did two years ago. The gap between open and closed models is closing faster than most people predicted, and the assumption that advanced AI is a US-only story is clearly wrong.