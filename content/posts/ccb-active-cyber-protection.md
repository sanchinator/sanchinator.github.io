...
description: "A Tech & Meet session with CCB, Belgian Cyber Force, and EgovSelect on Belgium's national cyber defence."
---

![Cyber Operation Framework — Protect, Collect, Defend, Fight](/images/ccb-framework.png)

I went in expecting a general overview of cybersecurity in Belgium. What I got was more specific — two hours of concrete detail about how the country actually organises its cyber defence, who does what, and what kinds of people they're looking for.

Three organisations presented: the Centre for Cybersecurity Belgium, the Belgian Cyber Force, and EgovSelect. Each covers a different slice of the same problem. CCB sits on the civilian side — preventing attacks, coordinating responses, sharing threat intelligence with companies and public institutions. The Cyber Force is on the military side, under Defence Cyber Command, with a framework split into Protect, Collect, Defend, and Fight. That last one includes corrupting, deceiving, degrading, and destroying adversary systems. It's not something you usually see written plainly on a government slide.

![Belgium's cyber governance structure](/images/ccb-governance.png)

The governance diagram was worth sitting with. Belgium's cyber structure runs across security, law enforcement, military defence, and diplomacy, with intelligence sharing underneath and the private sector — ISPs, cloud providers, social media platforms, payment processors — layered below that. On paper it looks organised. Coordinating all of it in practice must be genuinely hard, and the speakers were fairly honest that the gaps exist.
